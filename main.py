...
# st.set_page_config(
#     page_title="Berlin EV Charging Station Analysis",  # Browser tab title
#     page_icon="⚡",  # Favicon (can be an emoji or URL to an icon)
...
# st.sidebar.info("Use the sidebar to explore features and provide feedback.")
